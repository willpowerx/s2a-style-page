...
_Auto-generated by the token release pipeline — verify before merge._
...
- `--s2a-color-iconbutton-background-primary-outlined-on-dark-defatul` (was `var(--s2a-color-transparent-white-00)`)
- `--s2a-color-iconbutton-border-primary-outlined-on-dark` (was `var(--s2a-color-gray-25)`)
- `--s2a-color-iconbutton-border-primary-solid-default` (was `var(--s2a-color-transparent-white-12)`)

### ♻️ Changed

- `--s2a-section-spacing-2xl`: `var(--s2a-layout-md)` → `var(--s2a-layout-lg)`
- `--s2a-section-spacing-4xl`: `var(--s2a-layout-xl)` → `var(--s2a-layout-lg)`
- `--s2a-section-spacing-xl`: `var(--s2a-layout-sm)` → `var(--s2a-layout-lg)`
